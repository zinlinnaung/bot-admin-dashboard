...
export default function BusinessAnalytics() {
  ...
  const cards = [
    ...
    [
      "Support ဖြေရှင်းချိန်",
      `${data.operations.averageSupportResolutionHours} နာရီ`,
    ],
    ["Failed orders (၃၀ ရက်)", data.operations.failedOrders30Days],
    ["Renewal reminders", data.renewal?.remindersSent || 0],
    ["Renewal clicks", data.renewal?.clicks || 0],
    ["Reminder → Purchase", `${data.renewal?.clickToPurchaseRate || 0}%`],
  ];
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-500">
          VPN business ရောင်းအား၊ conversion နှင့် customer retention
        </p>
      </div>
